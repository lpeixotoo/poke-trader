...
class TradesTest < ApplicationSystemTestCase
  ...
  test "creating a Trade" do
    ...
    fill_in "Ash pokemons", with: @trade.ash_pokemons
    fill_in "Brock pokemons", with: @trade.brock_pokemons
    fill_in "Created date", with: @trade.created_date
    check "Is fair" if @trade.is_fair
